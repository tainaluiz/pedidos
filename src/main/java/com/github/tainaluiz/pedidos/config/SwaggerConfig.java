...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
				...
				.apis(RequestHandlerSelectors.basePackage("com.github.tainaluiz.pedidos.resources"))
				.paths(PathSelectors.any()).build().apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {
		return new ApiInfo("API de pedidos", "API criada para fins de estudos com Spring Boot", "Versão 1.0", "",
				new Contact("Tainã luiz", "https://github.com/tainaluiz", ""), "", "", Collections.emptyList());
	}

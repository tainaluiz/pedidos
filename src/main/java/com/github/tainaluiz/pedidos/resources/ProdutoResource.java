...
import com.github.tainaluiz.pedidos.dto.ProdutoDTO;
import com.github.tainaluiz.pedidos.resources.utils.URL;
...
public class ProdutoResource {
	...
	public ResponseEntity<Page<ProdutoDTO>> findPage(@RequestParam(value = "nome", defaultValue = "") String nome,
		...
		List<Long> ids = null;
		try {
			ids = URL.decodeLongList(categorias);
		} catch (NumberFormatException e) {
			throw new IllegalParamException("Valor não permitido para o parâmetro categorias");
		}
